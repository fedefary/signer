...
Since the RestTemplate object does not change any of his state informations to process HTTP, the object is thread safe so the same instance can be shared among multiple process.
