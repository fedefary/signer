...
The library also guarantee that the signature have a single request validity, this feature makes useless any attempt to sniff the signature from the request.
